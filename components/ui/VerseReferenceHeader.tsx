...
// shows, since this is decorative context, not required content.
export function VerseReferenceHeader({ book, chapter, verseNumber, reference, compact }: VerseReferenceHeaderProps) {
  ...
  const pericope = getPericopeForVerse(book, chapter, verseNumber);
